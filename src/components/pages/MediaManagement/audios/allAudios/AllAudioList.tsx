...
export default function AllAudioListing() {
    ...
    if (!courseId) {
        navigate(PATH.AUDIOS.ROOT, { replace: true });
        return null;
    }
    ...
    return (
        <div className="all__note__listing h-full flex flex-col overflow-hidden">
            <div className="flex items-center gap-3 mb-4">
                <Link to={PATH.AUDIOS.ROOT} className="flex items-center gap-1 text-sm text-gray-600 hover:text-gray-900">
