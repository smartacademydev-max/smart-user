...
export default function ExplorePackageListing({ type }: Props) {
        ...
        <>
            <div className="h-full overflow-auto">
                ...
                {isLoading ? (
                    ...
                    <EmptyList
                        title={`No ${TYPE_LABEL[type]} packages found`}
                        description={`No ${TYPE_LABEL[type]} packages are available yet.`}
                    />
                )}
            </div>
